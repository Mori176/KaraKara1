...
﻿<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="CartPage.aspx.cs" Inherits="MiniProject_Karakara.CartPage" %>
    ...
    <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <div class="cart-wrapper">
            ...
            <asp:Label ID="lblMessage" runat="server" CssClass="message"
                Style="text-align: center; padding-bottom: 10px;" EnableViewState="false" />


            <asp:GridView ID="gvCart" runat="server" AutoGenerateColumns="False" CssClass="cart-table"
                EmptyDataText="Your cart is empty." AllowPaging="True" PageSize="5" OnRowDeleting="gvCart_RowDeleting"
                OnRowDeleted="gvCart_Deleted" PagerStyle-CssClass="cart-pager"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="TotalItemPrice" DataFormatString="RM {0:N2}" HeaderText="Sub Total"
                        ReadOnly="True" SortExpression="TotalItemPrice" />
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:LinkButton ID="btnDelete" runat="server" CommandName="Delete"
                                CommandArgument='<%# Eval("CartID") %>' Text="Remove" CssClass="remove-btn">
                            </asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server"
                ConnectionString="<%$ ConnectionStrings:ConnKarakara %>" SelectCommand="GetTotalBeforeTax"
            ...
            <div id="summaryHide" runat="server" class="cart-summary" visible="false">
                <table>
                    ...
                    <tr>
                        ...
                        <td><strong>
                                <asp:Label ID="lblAmountToPay" runat="server" Text="RM 0.00"></asp:Label>
                            </strong></td>
                    </tr>
                </table>
            </div>
            <asp:Button ID="btnConfirmOrder" runat="server" Text="Confirm Order" CssClass="confirm-order-btn"
                Visible="false" OnClick="btnConfirmOrder_Click" />
        </div>
